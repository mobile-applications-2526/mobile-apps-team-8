...
export function ChatInput({ newMessage, setNewMessage, handleSend, isRecording, toggleRecording }: ChatInputProps) {
...
const styles = StyleSheet.create({
  ...
  input: { flex: 1, paddingHorizontal: 12, paddingVertical: 8, borderWidth: 1, borderRadius: 24, marginRight: 8 },
